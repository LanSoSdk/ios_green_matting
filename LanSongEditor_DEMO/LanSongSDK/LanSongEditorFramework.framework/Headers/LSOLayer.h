...
//选中后, 没有边界颜色;
@property (readwrite, nonatomic) BOOL noEdgeWhenSelected;
...
@property(readwrite, nonatomic) BOOL gauFilter1Enable;
@property(readwrite, nonatomic) CGFloat gauFilter1BlurSize;
@property(readwrite, nonatomic) CGFloat gauFilter1BlurRadius;
@property(readwrite, nonatomic) CGPoint gauFilter1Point;
 

@property(readwrite, nonatomic) CGRect gauFilter1InView;
...
/**
 ...
 默认是78,建议范围0--100;
 */
@property (nonatomic,assign) CGFloat greenMattingColorHoldLevel;
...
-(void)getImageWithTime:(float)time handler:(void(^)(UIImage *image, BOOL finish))handler;
